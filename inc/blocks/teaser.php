<?php
  ...
  acf_register_block( array(
      ...
      'enqueue_assets' => function(){
        wp_enqueue_style( 'block-teaser', get_template_directory_uri() . '/assets/css/blocks/teaser.min.css' );
  ...
  function mas_block_teaser_render_callback( $block, $content = '', $is_preview = false ) {
    ...
    // Render the block.
    Timber::render( 'views/partials/blocks/teaser/teaser.twig', $context );
